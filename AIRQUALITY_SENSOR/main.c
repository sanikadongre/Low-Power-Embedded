...
int main(void)
{
   ...
   // persistent_memory_load(&reset_counter,reset_counter_address );
    ...
    random_no_display = rand();
    GRAPHICS_AppendString("MITM Display");
    GRAPHICS_AppendString("Security Password");
	//print_number(random_no_display);
	GRAPHICS_Update();
